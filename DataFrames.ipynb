   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "\u001b[2K     \u001b[90m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\u001b[0m \u001b[32m310.8/310.8 MB\u001b[0m \u001b[31m1.5 MB/s\u001b[0m eta \u001b[36m0:00:00\u001b[0m00:01\u001b[0m00:01\u001b[0m\n",
      ...
      "\u001b[?25h  Created wheel for pyspark: filename=pyspark-3.4.1-py2.py3-none-any.whl size=311285398 sha256=28f1559b28e8d74cc3b3ffea5db0b54ab1f71e5f1ff391ddbc77bcad3f57672a\n",
   ...
   "outputs": [
    {
     ...
     "traceback": [
      ...
      "\u001b[0;31mValueError\u001b[0m: Cannot run multiple SparkContexts at once; existing SparkContext(app=pyspark-shell, master=local[*]) created by __init__ at /tmp/ipykernel_68/653474904.py:2 "
     ]
    }
   ],
   "source": [
   ...
   "outputs": [
    {
     "data": {
      "text/html": [
       ...
       "\n",
       "            <p><a href=\"http://jupyterlab-varunkishork:4040\">Spark UI</a></p>\n",
       "\n",
       "            <dl>\n",
       "              <dt>Version</dt>\n",
      ...
      "text/plain": [
       "<pyspark.sql.session.SparkSession at 0x7f87b1d69650>"
      ]
     },
     "execution_count": 7,
     "metadata": {},
